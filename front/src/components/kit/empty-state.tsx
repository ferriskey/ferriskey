...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'grid place-items-center rounded-sm border border-dashed border-fk-line bg-white px-6',
        compact ? 'py-8' : 'py-16',
        className
      )}
    >
      ...
      {hint && (
        <p className='mt-1 max-w-sm text-center text-sm text-neutral-500'>{hint}</p>
      )}
