...
export function NextSidebar({
  ...
  const base = NEXT_URL(realm_name ?? 'master')
    ...
    >
      ...
      >
        <div className={cn('flex items-center', collapsed ? 'justify-center' : 'pl-1')}>
          {!collapsed && (
            <span className='rounded border border-fk-primary-border bg-fk-primary-soft px-1.5 py-0.5 font-mono-ui text-[11px] text-fk-primary-text'>
              next
            </span>
          )}
          <Tooltip>
