...
import { updateUserValidator } from '@/pages/user/validators'
import { Schemas } from '@/api/api.client'
import PageUserDetail from '@/next/pages/iam/user/ui/page-user-detail'
import UserCredentialsFeature from '@/next/pages/iam/user/feature/user-credentials-feature'
import UserRoleMappingFeature from '@/next/pages/iam/user/feature/user-role-mapping-feature'
import UserOrganizationsFeature from '@/next/pages/iam/user/feature/user-organizations-feature'
import UserAttributesFeature from '@/next/pages/iam/user/feature/user-attributes-feature'
