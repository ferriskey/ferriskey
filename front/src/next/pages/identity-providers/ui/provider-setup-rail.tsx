      ...
      >
        <div className='space-y-3'>
          <section className={cn(tokens.surface.panel, 'p-3')}>
            ...
            <div className='mt-3'>
              <p className='pb-1 text-[11px] font-medium text-neutral-700'>Redirect URI</p>
            ...
            <div className='mt-4 border-t border-fk-line-soft pt-3'>
              <p className='pb-1.5 text-[11px] font-medium uppercase tracking-wide text-neutral-500'>
                Setup steps
              </p>
              <ol className='space-y-1.5'>
                {setupSteps(template).map((step, index) => (
                  <li key={step} className='flex gap-2 text-[11px]'>
                    <span className='tnum shrink-0 text-neutral-400'>{index + 1}.</span>
            ...
            <div className='mt-4 border-t border-fk-line-soft pt-3'>
              ...
              {template.default_scopes.length > 0 ? (
                <>
                  <code className='block rounded-md border border-fk-line bg-neutral-50 px-2 py-1.5 font-mono-ui text-[11px] text-neutral-700'>
