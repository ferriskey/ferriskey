...
import { createOrganizationSchema } from '@/pages/iam/organization/schemas/create-organization.schema'
import PageCreateOrganization, {
  type CreateOrganizationDraft,
} from '@/pages/iam/organization/ui/page-create-organization'
  ...
  const handleSubmit = () => {
    ...
    createOrganization(
      ...
      },
      {
        ...
        onError: () => toast.error(t('organizations.toast.create_failed')),
      }
    )
  }
